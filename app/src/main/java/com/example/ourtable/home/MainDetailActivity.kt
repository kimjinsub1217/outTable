...
import com.example.ourtable.databinding.ActivityMainDetailBinding
import com.example.ourtable.model.Review
import com.example.ourtable.model.Row

class MainDetailActivity : AppCompatActivity() {
    private val binding: ActivityMainDetailBinding by lazy {
        ActivityMainDetailBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val model = intent.getParcelableExtra<Row>("cookModel2")
